#!/usr/bin/env python3
"""
Recuperation des codes promo Europcar depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/europcar.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/europcar.fr"
STORE_NAME = "Europcar"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Europcar depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-europcar)"
    }
    try:
